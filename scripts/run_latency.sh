...
for FILE_NAME in f_books f_fb f_lognormal f_normal f_udense f_usparse f_wiki f_osm; do
    ...
    g++ benchmark/run_latency.cpp -std=c++17 -march=native -fopenmp -O3 -w -o z_run_test && ./z_run_test >> benchmark/exp_latency.txt                     
done
...
for FILE_NAME in f_books f_fb f_lognormal f_normal f_udense f_usparse f_wiki f_osm; do
    for FANOUT in 16 64 256 1024; do
        echo "PGM + B+Tree: $FILE_NAME, $FANOUT";
