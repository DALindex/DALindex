...
// int main()
// {
//     // vector<tuple<uint64_t, uint64_t, uint64_t>> data_t;
//     // add_timestamp_partition("/data/Documents/data/f_books", data_t, 4, 1);

//     // cout << "Length = " << data_t.size() << endl;
//     // cout << get<0>(data_t.front()) << "," << get<1>(data_t.front()) << "," << get<2>(data_t.front()) << endl;
//     // for (int i = 1; i < 101; i++)
//     // {
//     //     cout << get<0>(data_t[i]) << "," << get<1>(data_t[i]) << "," << get<2>(data_t[i]) << endl;
//     // }
//     // cout << "..." << endl;
//     // cout << get<0>(data_t.back()) << "," << get<1>(data_t.back()) << "," << get<2>(data_t.back()) << endl;


//     // vector<string> filenames = {"/data/Documents/data/f_books", "/data/Documents/data/f_normal", "/data/Documents/data/f_osm"};
//     // vector<tuple<uint64_t, uint64_t, uint64_t>> data_t;
//     // add_timestamp_multiple_data(filenames, data_t, 2000000, 1);
...
//     vector<tuple<uint64_t, uint64_t, uint64_t>> data_t;
//     add_timestamp_skewness("/data/Documents/data/f_books", data_t, 3, 1);
