...
/*
DP-Seg used for detailed self-analysis
*/
    ...
    if (m_numPair)
    {
        ...
        if (predictPosMin < predictPosMax)
        {
            ...
            {  
                    ...
                    #elif (LOCAL_SEARCH == 1)
                    exponential_search_dp_left(newKey, actualPos);
                    #elif (LOCAL_SEARCH == 2)
                    binary_search_dp_left(newKey, actualPos, predictPos-predictPosMin);
                    #endif
                #else
                exponential_search_dp_left(newKey, actualPos, predictPos-predictPosMin);
                #endif
            ...
            else if (newKey > m_localData[predictPos].first)
            {
                    ...
                    #elif (LOCAL_SEARCH == 1)
                    exponential_search_dp_right(newKey, actualPos);
                    #elif (LOCAL_SEARCH == 2)
                    binary_search_dp_right(newKey, actualPos, predictPosMax-predictPos);
                    #endif
                #else
                exponential_search_dp_right(newKey, actualPos, predictPosMax-predictPos);
                #endif
    ...
    {     
        ...
        if (lowerBound < m_localData[predictPos].first) // Left of predictedPos
        {
            actualPos = predictPos;
                ...
                #elif (LOCAL_SEARCH == 1)
                exponential_search_dp_left(lowerBound, actualPos);
                #elif (LOCAL_SEARCH == 2)
                binary_search_dp_left(lowerBound, actualPos, predictPos-predictPosMin);
                #endif
            #else
            exponential_search_dp_left(lowerBound, actualPos, predictPos-predictPosMin);
            #endif
        ...
        else if (lowerBound > m_localData[predictPos].first) //Right of predictedPos
        {
            actualPos = predictPos;
                ...
                #elif (LOCAL_SEARCH == 1)
                exponential_search_dp_right(lowerBound, actualPos);
                #elif (LOCAL_SEARCH == 2)
                binary_search_dp_right(lowerBound, actualPos, predictPosMax-predictPos);
                #endif
            #else
            exponential_search_dp_right(lowerBound, actualPos, predictPosMax-predictPos);
            #endif
                                    ...
                                    vector<pair<Type_Key,int >> & updateSeg)
{
    ...
    // Only happens to first segment
    // if (newKey < m_currentNodeStartKey) //REMOVE LATER
    // {
    //     cout << "NOTE: newKey less than m_currentNodeStartKey (" << newKey << ")" << endl;
    // }
        ...
        if (predictPosMin < predictPosMax)
        {
            ...
            if (newKey < m_localData[predictPos].first) // Left of predictedPos
            {
                insertionPos = predictPos;
                    ...
                    #elif (LOCAL_SEARCH == 1)
                    exponential_search_dp_left(newKey, insertionPos);
                    #elif (LOCAL_SEARCH == 2)
                    binary_search_dp_left(newKey, insertionPos, predictPos-predictPosMin);
                    #endif
                #else
                exponential_search_dp_left(newKey, insertionPos, predictPos-predictPosMin);
                #endif
            ...
            else if (newKey > m_localData[predictPos].first) //Right of predictedPos
            {
                insertionPos = predictPos;
                    ...
                    #elif (LOCAL_SEARCH == 1)
                    exponential_search_dp_right(newKey, insertionPos);
                    #elif (LOCAL_SEARCH == 2)
                    binary_search_dp_right(newKey, insertionPos, predictPosMax-predictPos);
                    #endif
                #else
                exponential_search_dp_right(newKey, insertionPos, predictPosMax-predictPos);
                #endif
...
template<class Type_Key, class Type_Ts>
inline void DALseg<Type_Key,Type_Ts>::exponential_search_dp_right(Type_Key & targetKey, int & foundPos)
{
    #ifdef TUNE
    int predictPos = foundPos;
    #endif
...
template<class Type_Key, class Type_Ts>
inline void DALseg<Type_Key,Type_Ts>::binary_search_dp_right(Type_Key & targetKey, int & foundPos, int maxSearchBound)
{
    #ifdef TUNE_TIME
    int predictPos = foundPos;
    uint64_t temp = 0;
...
template<class Type_Key, class Type_Ts>
inline void DALseg<Type_Key,Type_Ts>::exponential_search_dp_left(Type_Key & targetKey, int & foundPos)
{
    #ifdef TUNE
    int predictPos = foundPos;
    #endif
...
template<class Type_Key, class Type_Ts>
inline void DALseg<Type_Key,Type_Ts>::binary_search_dp_left(Type_Key & targetKey, int & foundPos, int maxSearchBound)
{
    #ifdef TUNE_TIME
    int predictPos = foundPos;
    uint64_t temp = 0;
